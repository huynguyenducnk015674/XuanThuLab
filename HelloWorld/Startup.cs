...
namespace HelloWorld
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles();
            // Trước khi gọi Endpointing phài có dùng MiddleWare này
            app.UseRouting();
            // Định nghĩa những điểm truy cập từ Web. Request từ user và reponse theo ý 
            app.UseEndpoints(endpoints =>
            {
                ...
                // Trang đầu tiên 
                endpoints.MapGet("/firstpage", async context =>
                 {
